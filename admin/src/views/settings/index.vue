    ...
    <el-card>
      <el-form :model="form" label-width="140px">
        ...
        <el-form-item label="客服电话">
          <el-input v-model="form.servicePhone" style="width: 300px" />
        </el-form-item>
        <el-form-item label="平台公告">
          <el-input v-model="form.announcement" type="textarea" :rows="3" style="width: 500px" />
        </el-form-item>
        ...
        <el-form-item label="争议提醒">
          <el-switch v-model="form.disputeNotify" />
        </el-form-item>
